...
<head>
    ...
    <title>Verify Email Basic - Pages | Vuexy - Bootstrap Admin Template</title>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-start mb-0">
                        Account activation link sent to your email address: <span class="fw-bold">{{
                            auth()->user()->email }}</span>. Please follow the link
                        inside to continue.
                    </p>
                    <a class="btn btn-primary w-100 my-6" href="{{ route('dashboard') }}"> Skip for now </a>
