      ...
      <li class="nav-item navbar-dropdown dropdown-user dropdown">
        <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
          <div class="avatar avatar-online">
            <img src="{{ auth()->user()->profile_photo ? asset('storage/'.auth()->user()->profile_photo) : asset('assets/img/avatars/1.png') }}" alt class="rounded-circle" style="width: 38px; height: 38px; object-fit: cover;" />
          </div>
        </a>
        <ul class="dropdown-menu dropdown-menu-end">
          <li>
                ...
                <div class="flex-shrink-0 me-2">
                  <div class="avatar avatar-online">
                    <img
                      ...
                      alt class="rounded-circle" style="width: 38px; height: 38px; object-fit: cover;" />
                  </div>
                </div>
                <div class="flex-grow-1">
